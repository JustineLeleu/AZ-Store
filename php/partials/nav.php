<header class="header h-20 flex flex-row justify-center items-center  p-4 ">
    ...
    <ul class="navContainer flex flex-row space-x-4">
        <li><a class="navItems mx-5" href="/php/index.php">Home</a></li>
        <li><a class="navItems mx-5" href="/php/index.php#section-4">About</a></li>
        <li><a class="navItems mx-5" href="/php/index.php#products-container">Products</a></li>
